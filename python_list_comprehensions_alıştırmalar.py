...
new_list = ["NUM_" + col.upper() if df[col].dtypes != "O" else col.upper() for col in df.columns]
print(new_list)
...
new_list = [col.upper() + "_FLAG" if "no" not in col else col.upper() for col in df.columns]
print(new_list)
